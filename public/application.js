...
var onCreatePlayer = function onCreatePlayer(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createPlayer(data).then(ui.createPlayerSuccess).catch(ui.createPlayerFailure);
};
var onUpdatePlayer = function onUpdatePlayer(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updatePlayer(data).then(ui.updatePlayerSuccess).catch(ui.updatePlayerFailure);
};

var onGetAllPlayers = function onGetAllPlayers(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.getAllPlayers(data).then(ui.getAllPlayersSuccess).catch(ui.getAllPlayersFailure);
};

var onGetYourPlayers = function onGetYourPlayers(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.getYourPlayers(data).then(ui.getYourPlayersSuccess).catch(ui.getYourPlayersFailure);
};

var onDeletePlayers = function onDeletePlayers(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.deletePlayers(data).then(ui.deletePlayersSuccess).catch(ui.deletePlayersFailure);
};
...
var getAllPlayers = function getAllPlayers(data) {
  return $.ajax({
    url: config.apiUrl + '/players',
    method: 'GET',
    headers: {
...
var getYourPlayers = function getYourPlayers(data) {
  return $.ajax({
...
var deletePlayers = function deletePlayers(data) {
  return $.ajax({
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://baseball-database.herokuapp.com',
...
var updatePlayerFailure = function updatePlayerFailure() {
...
var getAllPlayersSuccess = function getAllPlayersSuccess(data) {
  ...
  if (data.players.length > 0) {
    ...
    for (var i = 0; i < data.players.length; i++) {
      var playerName = data.players[i].name;
      var playerId = data.players[i].id;
...
var getAllPlayersFailure = function getAllPlayersFailure() {
...
var getYourPlayersSuccess = function getYourPlayersSuccess(data) {
  // Clears form fields
...
var getYourPlayersFailure = function getYourPlayersFailure() {
...
var deletePlayersSuccess = function deletePlayersSuccess(data) {
  $('#message2').text('Successfully deleted your players');
  $('#message2').css('background-color', 'green');
  $('#delete-players').trigger('reset');
};
var deletePlayersFailure = function deletePlayersFailure() {
...
module.exports = {
  ...
  getAllPlayersFailure: getAllPlayersFailure,
  getYourPlayersSuccess: getYourPlayersSuccess,
  getYourPlayersFailure: getYourPlayersFailure,
  deletePlayersSuccess: deletePlayersSuccess,
  deletePlayersFailure: deletePlayersFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
